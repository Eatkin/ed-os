...
// Standard Home icon
export const HomeIcon = ({ color = "currentColor", size = 20 }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <Path
      d="M5 10V20C5 20.5523 5.44772 21 6 21H9C9.55228 21 10 20.5523 10 20V15C10 14.4477 10.4477 14 11 14H13C13.5523 14 14 14.4477 14 15V20C14 20.5523 14.4477 21 15 21H18C18.5523 21 19 20.5523 19 20V10"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Standard Plus icon — for the floating "Add Log" center button
export const PlusIcon = ({ color = "currentColor", size = 20 }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Standard Bulb icon — for Prompts (nudges/ideas)
export const BulbIcon = ({ color = "currentColor", size = 20 }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path
      d="M12 3C8.68629 3 6 5.68629 6 9C6 11.2208 7.2066 13.1599 9 14.1973V16C9 16.5523 9.44772 17 10 17H14C14.5523 17 15 16.5523 15 16V14.1973C16.7934 13.1599 18 11.2208 18 9C18 5.68629 15.3137 3 12 3Z"
      stroke={color}
      strokeWidth="2"
      strokeLinejoin="round"
    />
...
// Custom Svg Sword vector icon
export const SwordIcon = ({ color = "currentColor", size = 32 }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
